...
<div class="row-with-strip row_block row_block__indent-1 row__style gallery thumbs">
    <div class="container" id="tabs">
        ...
        <h3 class="preffix_0">Software Prototyping Services</h3></br>
        <h4 class="preffix_0" >WHY PROTOTYPING?</h4>
        ...
        <div class="row">
            <div class="grid_4">
                <h4 class="preffix_0 row_block__indent-5">WHAT WE DO</h4>
                <ul class="list left-block">
                    <li>
        ...
        <div class="row">
            <div class="grid_4">
                <h4 class="preffix_0 row_block__indent-5" >WHAT WE DELIVER</h4>
                <ul class="list left-block">
                    <li>
                        <p>Specification</p>
                </ul>
