                    ...
                    <div class="info-col_col info-col_col__img-indent bg">
                        <div class="box">
                            <div class="maxheight">
                                ...
                                <a href="http://cargoplanning.com/"><h4>CargoPlanning</h4></a>
                                <p>
                                    CargoPlanning is an online IT platform that assists manufacturing and commercial companies in their freighting processes. CargoPlanning is a simple and efficient answer to the management of shipping orders, all the way from the placement of the shipping order, choosing and confirming the logistic partner to freight shipping and obtaining final documentation.
                                </br> </br>
            ...
            <div class="grid_4">
                <div class="left-block">
                    <div class="info-col_col info-col_col__img-indent bg last">
                        <div class="box">
                            <div class="maxheight">
                                <a href="images/carti-romanesti.jpg" class="thumbs_img">
                                    <div>
                                        <div class="lbHover"><span>+</span></div>
                                        <img src="images/carti-romanesti.jpg" alt="">
                                    </div>
                                </a>
                                <a href="https://cartiromanesti.co.uk/ro/"><h4>Romanian Books</h4></a>
            ...
            <div class="grid_4">
                <div class="left-block">
                    <div class="info-col_col info-col_col__img-indent bg last">
                        <div class="box">
                            <div class="maxheight">
                                <a href="images/sophia-logo.jpg" class="thumbs_img">
                                    <div>
                                        <div class="lbHover"><span>+</span></div>
                                        <img src="images/sophia-logo.jpg" alt="">
                                    </div>
                                </a>
                                <a href="http://www.sophia-romania.ro/"><h4>Sophia Romania</h4></a>
            ...
            <div class="grid_4">
                <div class="left-block">
                    <div class="info-col_col info-col_col__img-indent bg last">
                        <div class="box">
                            <div class="maxheight">
                                <a href="images/avocat-logo.jpg" class="thumbs_img">
                                    <div>
                                        <div class="lbHover"><span>+</span></div>
                                        <img src="images/avocat-logo.jpg" alt="">
                                    </div>
                                </a>
                                <a href="http://avocatcarmendiaconu.ro/en/home/"><h4>Avocat Carmen Diaconu</h4></a>
            ...
            <div class="grid_4">
                <div class="left-block">
                    <div class="info-col_col info-col_col__img-indent bg">
                        <div class="box">
                            <div class="maxheight">
                                <a href="images/logisoft.jpg" class="thumbs_img">
                                    <div>
                                        <div class="lbHover"><span>+</span></div>
                                        <img src="images/logisoft.jpg" alt="">
                                    </div>
                                </a>
                                <h4>LogiSoft</h4>
            ...
            <div class="grid_4">
                <div class="left-block">
                    <div class="info-col_col info-col_col__img-indent bg">
                        <div class="box">
                            <div class="maxheight">
                                <a href="images/fabrics.jpg" class="thumbs_img">
                                    <div>
                                        <div class="lbHover"><span>+</span></div>
            ...
            <div class="grid_4">
                <div class="left-block">
                    <div class="info-col_col info-col_col__img-indent bg">
                        <div class="box">
                            <div class="maxheight">
                                <a href="images/stock.jpg" class="thumbs_img">
                                    <div>
                                        <div class="lbHover"><span>+</span></div>
